export default function About() {
  return (
    <div className="about pb-10 md:pb-40 px-5  lg:px-20  pt-20" id='about'>
    ...
    <div className='md:flex grid  gap-10  md:gap-20  justify-between px-5 lg:px-10'>
      ...
      <div className="right ">
        ...
        <div className="skills text-base   sm:text-lg grid gap-2 sm:gap-5 grid-cols-3 md:grid-cols-2  lg:grid-cols-3 ">
