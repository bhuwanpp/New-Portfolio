...
export default function About() {
  return (
    <div className="about pb-10 md:pb-40 px-10 lg:px-20  pt-20" id='about'>
    ...
    <div className='md:flex grid  gap-10 md:gap-20  justify-between px-5 lg:px-10'>
      <div className="left w-80 sm:w-[425px] text-lg">
        <h2 className='font-semibold text-xl pb-2 '>Who am I ? </h2>
        <h5 className='font-normal'>Hi! I'm Bhuwan Paudel, a software developer who loves to build website.
        <p className='pt-2'>
      ...
      <div className="right ">
        ...
        <div className="skills text-base sm:text-lg grid gap-5 grid-cols-3 md:grid-cols-2  lg:grid-cols-3 ">
        <h5 className='bg-blue-200 hover:text-black text-center
          rounded-md  hover:rotate-6  duration-500 py-2 w-24 sm:w-28 m-2'>Javascript</h5>
        <h5 className='bg-blue-200 hover:text-black  text-center py-2 rounded-md
         duration-500 hover:-rotate-6 w-24 sm:w-28 m-2' > React </h5>
        <h5 className='bg-blue-200 hover:text-black  px-1 sm:px-2 text-center rounded-md 
        hover:rotate-6 duration-500 py-2  w-24 sm:w-28 text-nowrap m-2 '>TailwindCss</h5>
        <h5 className='bg-blue-200 hover:text-black px-2 text-center rounded-md
        hover:rotate-6 duration-500   w-24 sm:w-28 py-2 m-2'>Git</h5>
        <h5 className='bg-blue-200 hover:text-black px-2 text-center rounded-md
        hover:-rotate-6 duration-500 w-24  sm:w-28 py-2 m-2'>Html</h5>
        <h5 className='bg-blue-200 hover:text-black w-24 sm:w-28 px-2 text-center rounded-md 
        hover:rotate-6 duration-500 py-2 m-2'>Css</h5>
 </div>
